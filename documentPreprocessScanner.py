...
def getImageEdgeDetector(image):

    imgBlur = cv2.GaussianBlur(image, (5, 5), 1)  # ADD GAUSSIAN BLUR
    ...
    return cv2.erode(imgDial, kernel, iterations=1)  # APPLY EROSION

def getImageContours(image, original):
